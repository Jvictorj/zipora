...
<html lang="pt-br">
  <head>
    ...
    <title>area cliente</title>
     ...
     <link rel="stylesheet" href="../../assets/css/areacliente/alterarsenha.css">
  ...
  <?php include_once '../../includes/headercliente.php'; ?>
    ...
    <!--estrutura da pagina-->
    <div class="logo-img">
      <a href="index.php"><img src="Imagens/unipet.png" alt="" /></a>
    </div>
  </header>
  ...
  <div class="mensagem-boas-vinda" style="color: var(--cor-secundaria)">
    ...
    <div class="row">
      ...
      <div class="Redefiner-senha"style="color: var(--cor-secundaria)">
        <div class="contener-newSenha">
          <div class="top">
            <p><b>Alterar senha</b></p>
          </div>
          <form action="../../actions/alterar_senha.php" method="POST" class="space-senha">
              <div class="input-box">
                  <label>Nova Senha</label>
                  <input type="password" name="nova_senha" class="nova_senha" required />
              </div>
              <div class="input-box">
                  <label>Confirmar Nova Senha</label>
                  <input type="password" name="confirmar_nova_senha" required />
              </div>
